...
INSERT INTO employees(name, last_name, email, username, password, department_id) VALUES ('John', 'Doe', 'john@doe.com', 'johndoe', 'password123', 1);
INSERT INTO employees(name, last_name, email, username, password, department_id) VALUES ('Jane', 'Smith', 'jane@smith.com', 'janesmith', 'password456', 2);
